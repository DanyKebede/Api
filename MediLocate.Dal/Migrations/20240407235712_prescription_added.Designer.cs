...
namespace MediLocate.Dal.Migrations
{
    ...
    [Migration("20240407235712_prescription_added")]
    partial class prescription_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediLocate.Domain.Model.Prescription", b =>
                {
            ...
            modelBuilder.Entity("MediLocate.Domain.Model.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MediLocate.Domain.Model.Prescription", b =>
                {
                    ...
                    b.HasOne("MediLocate.Domain.Model.User", "User")
                        .WithMany("Prescriptions")
